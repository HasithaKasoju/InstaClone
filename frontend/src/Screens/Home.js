...
export default function Home() {
  ...
  src={post.photo} 
  onClick={() => {
    console.log("user of the post :", post.postedBy.Photo);
...
/>
              ...
              >
                <div className="card-pic">
                  <img
                    ...
                    src={item.postedBy.Photo}  //here comes the image
                    alt="hello"
                  />
                </div>
  ...
  return (
    <div className="comment" key={it.id}>
      <span className="commenter">
        <img src={it.postedBy.Photo} className="commenter-photo" alt="Commenter" />
        <p className="commenter-name">
        <Link to ={`../Profile/${it.postedBy._id}`}>
              {it.postedBy ? it.postedBy.name : "Unknown User"}</Link>
        </p>
      </span>
